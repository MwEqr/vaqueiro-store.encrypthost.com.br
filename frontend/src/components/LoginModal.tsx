      ...
      <div className="relative bg-white w-full max-w-md p-8 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm"><span className="px-2 bg-white text-premium-400">Ou continue com</span></div>
          </div>
          
          <button 
            type="button"
            onClick={() => alert('O Login com o Google exige a configuração do Google Cloud Console no seu WordPress. Em breve!')}
            className="w-full bg-white border border-premium-200 text-premium-900 py-3.5 hover:bg-premium-50 transition-colors font-medium text-sm tracking-wide flex items-center justify-center gap-3"
          >
